    ...
    return(
        <div className="border p-6 shadow rounded">
            ...
            <div className="flex items-center gap-3 mt-2 text-xs">
                <span className="bg-blue-50 broder border-blue-200 px-4 py-1.5 rounded">{job.location}</span>
                <span className="bg-red-50 broder border-red-200 px-4 py-1.5 rounded">{job.level}</span>
            </div>
