    ...
    return(
        <>
            ...
            <div className="container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10">
                ...
                <div className="flex gap-2 mb-6 mt-3">
                    {
                        ...
                        <button onClick={updateResume} className="cursor-pointer bg-green-100 border border-green-400 rounded-lg px-4 py-2">Save</button>
                ...
                <h2 className="text-xl font-semiboldmb-4">Jobs Applied</h2>
                <table className="min-w-full bg-white border rounded-lg border-gray-100">
                    <thead>
                        <tr>
                            ...
                            <th className="py-3 px-4 border-b text-left max-sm:hidden border-gray-100 ">Location</th>
                            <th className="py-3 px-4 border-b text-left max-sm:hidden border-gray-100">Date</th>
                    ...
                    <tbody>
                        {userApplications.map((job,index)=>true ? (
                            <tr key={index}>
                                ...
                                <td className="py-2 px-4 border-b max-sm:hidden border-gray-100">{job.jobId.location}</td>
